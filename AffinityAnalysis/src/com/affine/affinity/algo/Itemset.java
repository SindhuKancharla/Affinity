...
public class Itemset {
	...
	private Itemset(Itemset itemset) {
		this.items = new HashSet<Item>(itemset.items);
	}
	...
	private void generateAllNonEmptySubsets(Vector<Item> itemsVector, int level,
			Set<Itemset> allNonEmptySubsets, Itemset currentItemset) {
	 ...
	 */
	public Set<Itemset> generateAllNonEmptySubsets() {
		HashSet<Itemset> allNonEmptySubsets = new HashSet<Itemset>();
		generateAllNonEmptySubsets(new Vector<Item>(items), 0, allNonEmptySubsets,
				new Itemset());
