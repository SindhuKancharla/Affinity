...
<link rel="stylesheet" type="text/css"href="resourcefiles/js/httpcdn.datatables.net1.10.2cssjquery.dataTables.css">
 <link rel="stylesheet" type="text/css"href="resourcefiles/js/httpcdn.datatables.nettabletools2.2.2cssdataTables.tableTools.css">
 <script type="text/javascript" charset="utf8"src="resourcefiles/js/httpcdn.datatables.nettabletools2.2.2jsdataTables.tableTools.js"></script>
...
$(function() 
{
	...
	$(".dropdown-menu li ").click(function(){
		  var selText = $('#dropdownMenu1').val($(this).text()).val();
		  $(this).parents('.btn-group').find('.dropdown-toggle').html(selText+' <span class="caret"></span>');
		});
...
<div class="col-md-2" id="left">
			<ul class="nav nav-pills nav-stacked" id="leftnav">
				...
				<!-- <li class="dropdown"><a href="configurerules.html"><span class="glyphicon glyphicon-pencil"></span> Configure Rules</a></li> -->
					<li class="btn-group">
						<a class="btn dropdown-toggle btn-select2" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-pencil"></span> Configure Rules
	...
	<!--div id='topnavDIV' class='topnavContainer'><div class='container-fluid' style='max-width:1600px;margin-left:450px;padding-left:0;' -->
		...
		<div class="col-md-12 btn-group">
			<div class="dropdown" style="display:inline-block;">
				<button class= "btn dropdown-toggle btn-select2" id="dropdownMenu1" type="button" data-toggle="dropdown" name="rundate" value="rundate">Select Date
				<span class="caret"></span></button>
				<ul class="dropdown-menu"  id="rundate">
	...
	<div class=" col-md-12" id ="abc">
		  <h5>Select Across</h5>
			<form role="form" id="SA">
				<div class="btn-group col-md-2" id="dep_div">
					<div class="btn-group">
				...
				<div class=" btn-group col-md-2">				
						<button class="btn dropdown-toggle" id="dropdownMenu4" type="button" data-toggle="dropdown">Select Strategy
						<span class="caret"></span></button>
						<ul class="dropdown-menu">
						  <li><a href="#">Bundling</a></li>
						  <li><a href="#">Placement</a></li>
			...
			$('#two').click(function(){
				...
				if((typeof affinitytype === 'Select Strategy')){
