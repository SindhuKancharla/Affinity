...
<div class="col-md-10" >
	...
	<div class="col-md-8" id="matrixplot">		
	...
	var svg = d3.select("#runaffinity").append("svg")
 ...
 <div class="col-md-4">
		<div id="matrixlegend">	<!-- <p id="lifttext">Lift</p> -->
		<script>
		var w = 200,
    h = 200,
    r = 150,
...
data = [{"label":"High Prevalence of buying together", "value":793},
		...
		var legend = d3.select("#matrixlegend").append("svg")
		.attr("class", "legend")
		.attr("width", r* 2)
		.attr("height", r )
		.selectAll("g")
